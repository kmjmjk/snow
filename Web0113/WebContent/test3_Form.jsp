...
<div style="width:900px">
 <form name="myform"  action="test3_Save.jsp">
   <fieldset>
   	...
   	<div class="input_group">
   		<label>파일:</label>
   		<label> <input type="file" name="myfile" size=20> </label>
   	</div>
   	
   	<div class="input_group">
   		<label>내용:</label>
   		<label> <textarea name="memo" rows="3" cols="30">Best Coffee</textarea> </label>
   	</div>
   	...
   	<div class="input_group">
   		<label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </label>
   		<input type="button"  value="버튼전송"  onClick="move();">
