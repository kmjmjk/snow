	...
	<script type="text/javascript">
	  function handleFileSelect(){
	        ...
	        reader.onload = (function(theFile) {
	          ...
	          var img_view = ['<img src=', e.target.result + '  width="250" height="180"  alt="tis" />'].join('');
	          alert(img_view);
...
<body>
	<form action="BBB.jsp" met="post"  enctype="multipart/form-data">
	     <input type="hidden" name="num" value="7789"> <br>
		 제목: <input type="text" name="title" value="snow"> <br>
	 	 파일: <input type="file" name="file1" id="file" onchange="previewFiles();"> <p>
