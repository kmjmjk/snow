		...
		<form method="get" action="bkprocess4.do">
			<div class="select">
				...
				<div class="widget">
					...
					<div id="timeselector">
						...
						<input type="radio" name="stime" id="radio-1" class="cbradio" value="10:00"> 
						<label for="radio-2">11:00</label>
						<input type="radio" name="stime" id="radio-2" class="cbradio" value="11:00"> 
						<label for="radio-3">12:00</label> 
						<input type="radio" name="stime" id="radio-3" class="cbradio" value="12:00"> <br>
						<label for="radio-4">13:00</label> 
						<input type="radio" name="stime" id="radio-4" class="cbradio" value="13:00"> 
						<label for="radio-5">14:00</label>
						<input type="radio" name="stime" id="radio-5" class="cbradio" value="14:00"> 
						<label for="radio-6">15:00</label> 
						<input type="radio" name="stime" id="radio-6" class="cbradio" value="15:00"> <br>
						<label for="radio-7">16:00</label> 
						<input type="radio" name="stime" id="radio-7" class="cbradio" value="16:00"> 
						<label for="radio-8">17:00</label>
						<input type="radio" name="stime" id="radio-8" class="cbradio" value="17:00"> 
						<label for="radio-9">18:00</label> 
						<input type="radio" name="stime" id="radio-9" class="cbradio" value="18:00"> <br>						
						</p>
					</div>
				</div>
			</div>
			<div class="check">
				<div class="chk_container">
					...
					<input type="text" id="sstylist" value="${last}" size="10">
					<input type="text" id="dayoffs" value="${off}" size="10">
					<input type="text" id="datepicker2" name="sdate" size="10"><br>
					<div id="tamount"> X월 X일 XX:XX 방문하실 예정이고, 예상 비용은: _____ 원입니다. 계속하시려면 다음을 누르세요.</div>
